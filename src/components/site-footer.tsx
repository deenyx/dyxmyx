...
export function SiteFooter({ showLegalLinks = true }: { showLegalLinks?: boolean }) {
  return (
    <footer className="mt-auto border-t border-neutral-800/80">
      <div className="mx-auto max-w-6xl px-6 py-10">
        ...
        <div className="flex flex-col gap-3 border-t border-neutral-800/80 pt-6 text-xs uppercase tracking-widest text-neutral-600 sm:flex-row sm:items-center sm:justify-between">
